        ...
        <div class="corner">
            <div class="corner-box">
                ...
                <div class="theme-row">
                    ...
                    <button type="button" class="theme-btn" id="asMainF1Btn" class="theme-btn as-f1-main" onclick="window.__ASShowHelp&&window.__ASShowHelp()" title="Help, tips & tricks (F1)">❓ F1 Help & Tips</button>
                </div>
